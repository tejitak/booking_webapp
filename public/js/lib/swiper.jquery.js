        ...
        s.updateSlidesProgress = function (translate) {
            ...
            for (var i = 0; i < s.slides.length; i++) {
                ...
                if (s.params.watchSlidesVisibility) {
                    ...
                    if (isVisible) {
                        // PATCH: do not show at initialization
            ...
            loadImageInSlide: function (index) {
                ...
                img.each(function () {
                    ...
                    s.loadImage(_img[0], src, false, function () {
                        // PATCH: callback to set src by own logic
                        if(s.params.lazyLoadingSrcConverter){
                            src = s.params.lazyLoadingSrcConverter(src, _img);
                        }
                        _img.attr('src', src);
